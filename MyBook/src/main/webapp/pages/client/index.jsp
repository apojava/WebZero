	...
	<Script type="text/javascript">
		$(function () {
			...
			$("button.addToCart").click(function () {
				...
				location.href = "http://localhost:8080/MyBook/cartServlet?action=addItem&id=" + phoneId;
...
<body>
	...
	<div id="main">
		<div id="book">
			...
			<div class="b_list">
				<div class="img_div">
					<img class="book_img" alt="" src="${phone.imgPath}" />
				</div>
				<div class="book_info">
					<div class="book_name">
					...
					<div class="book_author">
						...
						<span class="sp2">${phone.desiger}</span>
					</div>
