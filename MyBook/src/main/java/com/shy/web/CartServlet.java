...
//        CartItem cartItem = new CartItem(phone.getId(),phone.getName(),1,phone.getPrice(),phone.getPrice());
        CartItem cartItem = new CartItem(phone.getId(),phone.getName(),1,new BigDecimal(phone.getPrice()),new BigDecimal(phone.getPrice()));
