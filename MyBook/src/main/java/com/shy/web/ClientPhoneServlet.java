...
/**
 * @author shystart
 * @create 2021-03-29 上午 10:25
 */
@WebServlet(name = "ClientPhoneServlet",value = "/client/phoneServlet")
public class ClientPhoneServlet extends BaseServlet{
    ...
    protected void pageByPrice(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //2 调用BookService.page(pageNo，pageSize)：Page对象
        Page<Phone> page = phoneService.pageByPrice(pageNo,pageSize,min,max);

        StringBuilder sb = new StringBuilder("client/phoneServlet?action=pageByPrice");
